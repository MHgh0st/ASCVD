...
const numberInputFields: NumberInputConfig[] = [
  ...
  },
  {
    ...
    min: 130,
    max: 320,
    rangeErrorMessage: "سطح کلسترول باید بین 130 تا 320 mg/dl باشد",
  },
  {
    name: "HDLCholesterol",
  ...
  },
  {
    ...
    min: 30,
    max: 300,
    rangeErrorMessage: "سطح کلسترول بد LDL باید بین 30 تا 300 mg/dl باشد",
  },
  {
    ...
    min: 90,
    max: 200,
    rangeErrorMessage: "فشار خون سیستولیک باید بین 90 تا 200 mmHg باشد",
  },
  {
    ...
    min: 60,
    max: 130,
    rangeErrorMessage: "فشار خون دیاستولیک باید بین 60 تا 130 mmHg باشد",
  },
];
